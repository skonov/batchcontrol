...
/**
 * This service is started from JBoss microcontainer when JBoss is started. The
 * declaration is in
 * JBOSS_HOME/server/default/deploy/batchcontrol-jboss-beans.xml.
 * jboss-beans.xml can contains any parameters that are then passed to the
 * service constructor. Parameters are declared inside bean element, for
 * example: <constructor> <parameter>value1</parameter>
 * <parameter>value1</parameter> </constructor>
 * 
 * @author skonov
 *
 */
